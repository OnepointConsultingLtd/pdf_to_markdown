...
from pdf_to_markdown_llm.service.ollama_text_conversion import convert_pdf_to_markdown, convert_word_to_markdown
...
async def test_convert_pdf_to_markdown_ollama():
    ...
    result: ProcessResult = await convert_single_file(pdf_file, SupportedFormat.MARKDOWN, convert_pdf_to_markdown, convert_word_to_markdown)
